...
import com.tencent.kuikly.compose.ui.node.AlignmentLines
import com.tencent.kuikly.compose.ui.node.LayoutNodeAlignmentLines
import com.tencent.kuikly.compose.ui.node.LookaheadAlignmentLines
import com.tencent.kuikly.compose.ui.node.NodeCoordinator
import com.tencent.kuikly.compose.ui.node.LayoutNode.Companion.NotPlacedPlaceOrder
import com.tencent.kuikly.compose.ui.node.LayoutNode.LayoutState
...
//            lastExplicitLayer = layer
        ...
        fun replace() {
            try {
                ...
                onNodePlacedCalled = false
                val wasPlacedBefore = isPlaced
                placeSelf(lastPosition, 0f, lastLayerBlock)
                if (wasPlacedBefore && !onNodePlacedCalled) {
                    // parent should be notified that this node is not placed anymore so the
                    // children `placeOrder`s are updated.

...
expect inline fun <E> fastLinkedHashSetOf(): MutableSet<E>

expect inline fun <E> Collection<E>.toFastMutableSet(): MutableSet<E>

expect inline fun <E> Collection<E>.toFastSet(): Set<E>

expect inline fun <E> Collection<E>.toFastList(): List<E>

...
- [ ] 5.1 将以上所有改动（含 worktree 中已存在的 Phase 1/2 代码）整理为一个完整 commit，message：`feat(compose): add business custom filter API and overlay filter UI for RecompositionProfiler`
